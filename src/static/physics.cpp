...
//}
//
//void Physics::processPhysics(std::map<const std::string, std::shared_ptr<Collision>>& body_map)
//{
//    for (std::pair<const std::string, std::shared_ptr<Collision>> one : body_map)
//    {
//        for (std::pair<const std::string, std::shared_ptr<Collision>> two : body_map)
//        {
